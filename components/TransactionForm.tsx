  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 max-w-lg mx-auto">
      ...
      <div className="space-y-5">
        ...
        {/* Amount Field with Quick Select */}
        <div>
          ...
          <div className="flex gap-2 mt-3 overflow-x-auto no-scrollbar pb-1">
            {QUICK_AMOUNTS.map((amt) => (
              <button
                ...
                className="flex-shrink-0 px-4 py-2 bg-white border border-slate-100 rounded-xl text-[10px] font-black text-slate-500 hover:border-[#E31E24] hover:text-[#E31E24] transition-all"
              >
                +{CURRENCY}{amt}
              </button>
            ))}
