...
const ExportModal: React.FC<ExportModalProps> = ({ isOpen, onClose, transactions }) => {
  ...
  const messages = [
    ...
    'Authenticating SR INFOTECH session...',
          ...
          {syncState === 'idle' ? (
            <div className="grid grid-cols-1 gap-4">
              ...
              >
                ...
                <div className="flex-1">
                  <h3 className="font-bold text-slate-900">Sync to Google Drive</h3>
                  <p className="text-xs text-slate-500">Secure cloud backup to company workspace.</p>
                </div>
              ...
              <div className="mt-4 flex items-center gap-2 px-4 py-3 bg-slate-50 rounded-2xl border border-slate-100">
                ...
                <p className="text-[10px] text-slate-500 leading-tight">
                  Company data is encrypted during transit.
                </p>
              </div>
            </div>
          ) : syncState === 'syncing' ? (
            <div className="py-12 flex flex-col items-center text-center">
              <div className="relative mb-8">
                ...
                <Cloud size={24} className="absolute inset-0 m-auto text-red-400" />
              </div>
              <h3 className="text-lg font-bold text-slate-900 mb-2">Syncing with Cloud</h3>
            ...
            <div className="py-12 flex flex-col items-center text-center animate-in zoom-in-90 duration-300">
              ...
              <p className="text-slate-500 text-sm mb-8 px-8">
                Financial report successfully uploaded to SR INFOTECH Google Drive.
              </p>
              <button
                onClick={onClose}
