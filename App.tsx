...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] pb-32 md:pb-10 md:pl-20">
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <header className="flex flex-col md:flex-row md:items-end justify-between gap-4">
              <div>
                ...
                <h1 className="text-4xl font-black text-slate-900 tracking-tight">FinTrack Dashboard</h1>
              </div>
      ...
      {showCloudModal && (
        <div className="fixed inset-0 z-[120] flex items-center justify-center p-4 animate-in fade-in duration-300">
          ...
          <div className="relative bg-white w-full max-w-lg rounded-[3rem] shadow-2xl p-10 animate-in zoom-in-95 duration-300">
            ...
            <p className="text-slate-500 text-sm mb-8 leading-relaxed">Modify your Supabase connection. Leave fields empty to use the system defaults.</p>
            
            <form onSubmit={handleCloudSetup} className="space-y-5">
              ...
              <div className="pt-4 flex gap-3">
                <button
                  type="button"
                  onClick={() => { clearCloudCredentials(); setShowCloudModal(false); window.location.reload(); }}
      ...
      <ExportModal isOpen={isExportModalOpen} onClose={() => setIsExportModalOpen(false)} transactions={transactions} />
    </div>
  );
};
